...
const initialSingles = [
  ...
  { id: 103, title: 'Wisp', year: 2025, type: 'EP', image: wispLogo, duration: '2:17', description: 'Mobile app that enables users to capture, refine, and organize ideas in under 5 seconds using only their voice through real-time AI.', tags: ['React Native', 'FastAPI', 'OpenAI API', 'MCP', 'Supabase'], orderingPriority: 5, github: 'https://github.com/Scr4tch587/wisp', website: '' },
  { id: 204, title: 'Waypost', year: 2025, type: 'Single', image: waypostLogo, duration: '4:02', description: 'Sustainable travel platform using QR-based item tracking to support local businesses and the circular economy. \n\n 2nd place at Newhacks 2025', tags: ['FastAPI', 'React', 'Firebase', 'Cloudinary'], orderingPriority: 6, github: 'https://github.com/Scr4tch587/waypost', website: 'https://devpost.com/software/hi-team' },
  { id: 305, title: 'kaizhang.ca', year: 2025, type: 'EP', image: squareLogo, duration: '2:45', description: 'The website you\'re browsing right now. A showcase of my projects, passions, and skills, packaged in a Spotify-inspired UI.', tags: ['React', 'Tailwind CSS', 'Firebase'], orderingPriority: 7, github: 'https://github.com/Scr4tch587/portfolio', website: 'https://kaizhang.ca' },
  { id: 306, title: 'Project Periodic', year: 2024, type: 'Single', image: projectPeriodicLogo, duration: '3:15', description: 'Educational survival game where players use chemical reactions to fight off enemies.', tags: ['GameMaker', 'GameMakerLanguage'], orderingPriority: 8, github: 'https://github.com/Scr4tch587/Project-Periodic', website: '' },
  { id: 307, title: "Kai's Music Blog", year: 2023, type: 'Single', image: kaisMusicBlogLogo, duration: '2:00', description: 'A blog platform where I share music reviews of songs and albums I enjoy.', tags: ['Substack'], orderingPriority: 9, github: '', website: 'https://kaizhang.substack.com/' },
];
